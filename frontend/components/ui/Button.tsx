...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-brand-600 text-white shadow-xs hover:bg-brand-500 hover:shadow-card active:bg-brand-700 disabled:bg-brand-300 disabled:shadow-none",
  secondary:
    "border border-slate-200 bg-white text-slate-700 shadow-xs hover:border-slate-300 hover:bg-slate-50 hover:shadow-card active:bg-slate-100 disabled:text-slate-400 disabled:shadow-none",
  ghost:
